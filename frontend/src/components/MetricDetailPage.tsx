...
import { METRIC_INFO } from "@/lib/metricsInfo";
import { pct } from "@/lib/series";
import type { Metric, MetricKey } from "@/lib/types";

const ms = (v: number) => `${Math.round(v)}ms`;
const fmtFor = (k: MetricKey) => (k === "avg_latency_ms" ? ms : pct);
      ...
      <Card>
        ...
        <CardContent>
          {metricKey === "false_positive_rate" ? (
            ...
            <MetricRadarChart metrics={metrics} className="aspect-square mx-auto w-full max-w-md" />
          )}
        </CardContent>
      </Card>
